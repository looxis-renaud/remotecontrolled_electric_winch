 ...
 * +++ Adding Support for an ESP32 T-Display Monitor that receives Information via ESP-NOW Protocol
 */
...
#include <esp_now.h> //Library for ESP-NOW Communication Protocol
#include <WiFi.h> //Required for ESP-NOW Communication Protocol

uint8_t receiverAdd[] = {0xDC, 0xDA, 0x0C, 0x5A, 0x59, 0x58}; // Add Mac-Address of Receiver/Monitor (ESP32 T-Display) here
